...
2026-03-07 | dry_run=False | to=stinncsky@gmail.com | days=6 | months=2 | years=3 | weather={'temperature': 1.31, 'temp_min': 1.39, 'temp_max': 1.39, 'condition': 'clear sky', 'humidity': 58, 'wind_speed': 2.19} | quote={'id': 116, 'content': '你酷酷地甩下一句‘我没事’，但我已经准备好了一百种哄你的方式。', 'category': 'funny', 'tags': ['酷', '哄']} | anniversary={'name': 'TA的生日', 'date': '2026-12-25', 'days_until': 293}
2026-03-07 | dry_run=False | to=stinncsky@gmail.com | days=6 | months=2 | years=3 | weather={'temperature': 1.89, 'temp_min': 1.98, 'temp_max': 8.25, 'condition': 'few clouds', 'humidity': 63, 'wind_speed': 0.36} | quote={'id': 78, 'content': '你像一阵春天的风，吹走了我整个冬天的寒冷。', 'category': 'romantic', 'tags': ['春风', '温暖']} | anniversary={'name': 'TA的生日', 'date': '2026-12-25', 'days_until': 293}
